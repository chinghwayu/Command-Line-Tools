...
<Project Type="Project" LVVersion="14008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="CLI Tools" Type="Folder">
			<Item Name="subVIs" Type="Folder">
				<Item Name="Check and Apply VIPC.vi" Type="VI" URL="../CLI Tools/subVIs/Check and Apply VIPC.vi"/>
				<Item Name="Construct LV Version String.vi" Type="VI" URL="../CLI Tools/subVIs/Construct LV Version String.vi"/>
				<Item Name="Suppress Dialogs.vi" Type="VI" URL="../CLI Tools/subVIs/Suppress Dialogs.vi"/>
			</Item>
			<Item Name="Build LV Spec.vi" Type="VI" URL="../CLI Tools/Build LV Spec.vi"/>
			<Item Name="Build VIPB Spec.vi" Type="VI" URL="../CLI Tools/Build VIPB Spec.vi"/>
			<Item Name="Run UTF Tests.vi" Type="VI" URL="../CLI Tools/Run UTF Tests.vi"/>
			<Item Name="Run VI Tester Tests.vi" Type="VI" URL="../CLI Tools/Run VI Tester Tests.vi"/>
		</Item>
		<Item Name="VI Tree - Command Line Tools.vi" Type="VI" URL="../VI Tree - Command Line Tools.vi"/>
		<Item Name="Command Line Tools.vipb" Type="Document" URL="../Command Line Tools.vipb"/>
